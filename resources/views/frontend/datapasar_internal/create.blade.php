...
<div class="box">
    <div class="box-header">
        <h5 class="box-title" style="text-align:center; color:dark-blue"><b>Data untuk objek ({{$datapasar->kerjainternals->peruntukan}}) lokasi di {{$datapasar->kerjainternals->alamat}} </b></h5><br>
    </div>
</div>
   <div class="box-body">
    <form action="{{ route('datapasar.updateinternal', $datapasar)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method("PUT")
        <div class="row">   

            <div class="input-field col s12">
                <input disabled value="{{date('d M Y', strtotime($datapasar->kerjainternals->tanggal_penilaian))}}" id="disabled"
                type="text" class="validate">
                <label for="disabled">Tanggal Inspeksi</label>
            </div>

            <div class="input-field col s12">
                <input disabled value="{{number_format($datapasar->kerjainternals->nilai_pasar)}}" id="disabled"
                type="text" class="validate">
            ...
            <div class="input-field col s12">
                <select name="peruntukan1" id="peruntukan" class="validate">
            ...
            <div class="input-field col s12">
                ...
                <label for="icon_prefix">Jarak Dengan Objek (m)</label>
            </div>
            ...
            <select name="province1" id="province" class="browser-default">
                <option value="{{$datapasar->province1 ?? old('province')}}" selected>{{$datapasar->province1 ?? ('Pilih Provinsi')}}</option>
            ...
            <select name="city1" id="city" class="browser-default">
                <option value="{{$datapasar->city1 ?? old('city')}}"selected>{{ $datapasar->city1 ?? ('Pilih Kota/Kab')}}</option>
            </select>
            </div>

            <div class="input-field col s12">
            <select name="districs1" id="districs" class="browser-default">
                <option value="{{$datapasar->districs1 ?? old('districs')}}"selected>{{$datapasar->districs1 ?? ('Pilih Kecamatan')}}</option>
            </select>
            </div>
