...
<div class="box">
    <div class="box-header">
        <h5 class="box-title" style="text-align:center; color:dark-blue"><b>Data bangunan objek ({{$bangunan->kerjainternals->peruntukan}}) lokasi di {{$bangunan->kerjainternals->alamat}}</b></h5><br>
    </div>
</div>
   <div class="box-body">
    <form action="{{ route('bangunan.updateinternal', $bangunan)}}" method="POST">
        @csrf
        @method("PUT")
        <div class="row">   
 
            <div class="input-field col s12">
                <input disabled value="{{number_format($bangunan->kerjainternals->nilai_pasar)}}" id="disabled"
                type="text" class="validate">
                <label for="disabled">Nilai Pasar Objek</label>
            </div>

            <div class="input-field col s12">
                <input disabled value="{{number_format($bangunan->kerjainternals->nilai_likuidasi)}}" id="disabled"
                type="text" class="validate">
                <label for="disabled">Nilai Likuidasi Objek</label>
            </div>

            <div class="input-field col s12">
                <input disabled value="{{number_format($bangunan->kerjainternals->luas_bangunan)}}" id="disabled"
                type="text" class="validate">
                <label for="disabled">Luas Bangunan Total</label>
            </div>
            ...
            <div class="input-field col s12">
                <input type="number" name="tahun_bangun" class="form-control" 
                placeholder="Input perkiraan tahun bangun" value="{{$bangunan->tahun_bangun ?? old('tahun_bangun')}}">
                <label for="">Tahun Bangun</label>
            </div>

            <div class="input-field col s12">
                <select name="struktur" class="form-control">
                    <option value=""></option>  
                    <option value="Beton Bertulang">Betok Bertulang</option>
                    <option value="Baja Profil">Baja Profil</option>
                    <option value="Kayu">Kayu</option>
                </select>
                <label for="">Struktur</label>
            </div>

            <div class="input-field col s12">
                <select name="plafon" class="form-control">
                    <option value=""></option>  
            ...
            <div class="input-field col s12">
                <select name="dinding" class="form-control">
                    <option value=""></option>  
                    <option value="Dilapis cat diplester dan diaci">Dilapis Cat (diplester & diaci)</option>
                    <option value="Dilapis wallpaper">Dilapis wallpaper</option>
                    <option value="Dilapis keramik lokal">Dilapis keramik lokal</option>
                    <option value="Dilapis batu alam">Dilapis batu alam</option>
                    <option value="Dilapis marmer lokal">Dilapis marmer lokal</option>
                    <option value="Dilapis granit">Dilapis granit</option>
                </select>
                <label for="">Penutup Dinding</label>
            </div>
            ...
            <div class="input-field col s12">
                <select name="pintu_jendela" class="form-control">
                    <option value=""></option>  
                    <option value="Kayu">Kayu</option>
                    <option value="Alumunium">Alumunium</option>
                    <option value="Rolling door">Rolling door</option>
                </select>
                <label for="">Pintu & Jendela</label>
            </div>
            ...
            <div class="input-field col s12">
                <select name="atap" class="form-control">
                    ...
                    <option value="Bitumen atau ondulin-onduvilla">Bitumen (ondulin/onduvilla)</option>
                    <option value="Asbes">Asbes</option>
