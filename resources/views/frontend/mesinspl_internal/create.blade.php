...
<div class="box">
    <div class="box-header">
        <h5 class="box-title" style="text-align:center; color:dark-blue"><b>Data Mesin/SPL objek ({{$mesinspl->kerjainternals->peruntukan}}) lokasi di {{$mesinspl->kerjainternals->alamat}}</b></h5><br>
    </div>
</div>
   <div class="box-body">
    <form action="{{ route('mesinspl.updateinternal', $mesinspl)}}" method="POST">
        @csrf
        @method("PUT")
        <div class="row">   

            <div class="input-field col s12">
                <input disabled value="{{number_format($mesinspl->kerjainternals->nilai_pasar)}}" id="disabled"
                type="text" class="validate">
                <label for="disabled">Nilai Pasar Objek</label>
            </div>

            <div class="input-field col s12">
                <input disabled value="{{number_format($mesinspl->kerjainternals->nilai_likuidasi)}}" id="disabled"
                type="text" class="validate">
