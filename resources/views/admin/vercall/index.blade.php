...
<div class="box">
    <div class="box-header">
        <h3 class="box-title">Verifikasi Progress</h3>
        <a href="{{route ('admin.vercall.create')}}" class="btn btn-primary">Tambah Order Baru</a><br><br>
    </div>
    <div class="box-body">
